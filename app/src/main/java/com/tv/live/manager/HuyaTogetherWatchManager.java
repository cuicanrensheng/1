...
public class HuyaTogetherWatchManager {
    ...
    private List<TogetherWatchRoom> parseCacheRoomList(String jsonStr, String categoryName) throws Exception {
        ...
        for (int i = 0; i < datas.length(); i++) {
            ...
            TogetherWatchRoom twRoom = new TogetherWatchRoom(roomId, roomName, nickName, 
    ...
    private List<TogetherWatchRoom> classifyRoomsByKeywords(List<TogetherWatchRoom> sourceRooms, 
        ...
        for (TogetherWatchRoom room : sourceRooms) {
            ...
            if (matchedCategory != null) {
                result.add(new TogetherWatchRoom(room.roomId, room.roomName, room.nickName,
    ...
    private List<TogetherWatchRoom> getFallbackRooms() {
        ...
        rooms.add(new TogetherWatchRoom(1394575534, "【周星星】星爷经典不间断", "周星星", "", 5000, "电影_星爷"));
        rooms.add(new TogetherWatchRoom(1394575543, "英叔护体 | 林正英搞笑僵尸系列", "7喜先生", "", 4500, "电影_英叔"));
        rooms.add(new TogetherWatchRoom(1524439855, "我摊牌啦 一起看热门大片", "虎牙八点档", "", 6000, "电影_推荐"));
        rooms.add(new TogetherWatchRoom(616112, "动作大片", "虎牙一起看", "", 4500, "电影_动作电影"));
        rooms.add(new TogetherWatchRoom(616113, "惊悚悬疑", "虎牙一起看", "", 4000, "电影_高分动作"));
        rooms.add(new TogetherWatchRoom(616114, "科幻世界", "虎牙一起看", "", 3500, "电影_宇宙"));
        rooms.add(new TogetherWatchRoom(616115, "古装巨制", "虎牙一起看", "", 3000, "电影_武侠"));
        
        rooms.add(new TogetherWatchRoom(616121, "古装剧集", "虎牙一起看", "", 4500, "剧集_古装"));
        rooms.add(new TogetherWatchRoom(616122, "军旅题材", "虎牙一起看", "", 4000, "剧集_军旅"));
        rooms.add(new TogetherWatchRoom(616123, "搞笑剧集", "虎牙一起看", "", 3500, "剧集_搞笑"));
        rooms.add(new TogetherWatchRoom(616124, "悬疑推理", "虎牙一起看", "", 3000, "剧集_悬疑"));
        rooms.add(new TogetherWatchRoom(616125, "都市情感", "虎牙一起看", "", 2500, "剧集_都市"));
        rooms.add(new TogetherWatchRoom(616126, "剧情精选", "虎牙一起看", "", 2000, "剧集_剧情"));
        
        rooms.add(new TogetherWatchRoom(660005, "动漫剧场", "虎牙一起看", "", 4500, "动漫_热门"));
        rooms.add(new TogetherWatchRoom(660004, "热门综艺", "虎牙一起看", "", 6000, "综艺_热门"));
        rooms.add(new TogetherWatchRoom(660006, "体育赛事", "虎牙一起看", "", 3000, "综艺_热门"));
        rooms.add(new TogetherWatchRoom(660007, "纪录片", "虎牙一起看", "", 2500, "电影_推荐"));
        rooms.add(new TogetherWatchRoom(660008, "演唱会", "虎牙一起看", "", 5000, "综艺_音乐"));
        rooms.add(new TogetherWatchRoom(660009, "游戏回放", "虎牙一起看", "", 3500, "电影_推荐"));
        return rooms;
    }
