...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        ...
        if (mPlayerManager != null) {
            // 🟢【修复内存泄漏】必须同时清空 onPlayerViewRecreatedListener，它捕获了 MainActivity.this
            mPlayerManager.setOnPlayerViewRecreatedListener(null);
            ...
            // 🟢【修复内存泄漏】解绑 channelNumberTextView，避免单例长期持有 Activity 的 View
            mPlayerManager.bindChannelText(null);
        ...
        // 🟢【修复内存泄漏】清理手势管理器的 Handler 回调与 Activity 引用
